...
# Connector Outputs
# Note: GitHub and Docker connectors are created via API due to Terraform provider bug
...
# Note: Infrastructure is created via API due to Terraform provider bug
